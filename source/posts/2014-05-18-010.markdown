...
* Для интересующихся реализацией chef-server можно глянуть [тут](https://github.com/ctdk/goiardi). Но это достаточно увесистый chef-server, неудобный тем что данные хранит либо в файле с go-серилизацией либо в mysql
